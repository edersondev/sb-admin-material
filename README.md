# SB Admin rewritten in Angular13 and Material13

Simple Dashboard Admin App built using Angular 13 and Material 13.
...
*   Developed using Material-v13.1.1
*   angular-v13.1.1
*   angular/cli-v13.1.1
*   angular/material-v13.1.1
*   angular/cdk-v13.1.1
*   angular/flex-layout-v13.0.0-beta.36
...
```bash
$ git clone https://github.com/edersondev/sb-admin-material.git
